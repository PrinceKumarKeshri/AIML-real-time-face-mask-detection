# -*- coding: utf-8 -*-
"""
Created on Wed May 12 18:53:28 2021

@author: 0526p
"""

from tensorflow.keras.models import load_model
detector = load_model('dummy.model', compile = 'True')
...
while True:
    ...
    for x, y, w, h in face:
        ...
        if label == 0:
            ...
            cv2.putText(new_image,"mask",(x,y),cv2.FONT_HERSHEY_SIMPLEX,0.8,(0,0,255),2)
        elif label == 1:
            cv2.rectangle(new_image,(x,y),(x+w,y+h),(0,255,0),2)
            cv2.putText(new_image,"no_mask",(x,y),cv2.FONT_HERSHEY_SIMPLEX,0.8,(0,255,0),2)
        else:
            None
